...
import axios from "axios";
import Spinner from "../components/Spinner";
// Gravity-UI থেকে প্রয়োজনীয় আইকনগুলো ইম্পোর্ট করা হলো
import { Star, MapPin, GraduationCap, Clock } from '@gravity-ui/icons';

// ── TUTOR CARD COMPONENT (আইকনসহ আপডেট করা হলো) ───────────────────
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow hover:shadow-lg transition border border-gray-100 dark:border-gray-700 flex flex-col h-full">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        {/* ইমোজির বদলে গ্র্যাভিটি ইউআই-এর রিয়েল আইকন সেকশন */}
...
// ── MAIN TUTORS COMPONENT (আপনার কোডটি একদম হুবহু রাখা হয়েছে) ───────
const Tutors = () => {
  const [tutors, setTutors] = useState([]);
  const [loading, setLoading] = useState(true);
  const [search, setSearch] = useState("");
