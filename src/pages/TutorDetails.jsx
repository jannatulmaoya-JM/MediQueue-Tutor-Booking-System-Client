...
// //                   <svg>https://gravity-ui.com/icons?icon=Star   
// //                        {tutor.rating}
// //                        </svg> 
// //                    {tutor.rating}
// //                   </p>
...
// //             {/* ইনফো গ্রিড (Location, Availability, Mode) */}
// //             <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
// //               {tutor.location && (
// //                 <div className="bg-gray-50 dark:bg-gray-700/40 border border-gray-100 dark:border-gray-700 rounded-xl p-3 text-sm">
...
// //               {tutor.availability && (
// //                 <div className="bg-gray-50 dark:bg-gray-700/40 border border-gray-100 dark:border-gray-700 rounded-xl p-3 text-sm">
// //                   <p className="text-gray-400 text-xs mb-1 font-medium">Availability</p>
...
// import Spinner from "../components/Spinner";
// import useAxiosSecure from "../hooks/useAxiosSecure";
// // এখানে Cloud এর সাথে Star আইকনটিও ইম্পোর্ট করে দেওয়া হয়েছে
// import { Cloud, Star } from '@gravity-ui/icons';
...
//                 {tutor.rating && (
//                   <p className="text-yellow-500 font-bold mt-1 flex items-center gap-1 sm:justify-end">
//                     {/* এখানে রিয়েল কোড আইকনটি পারফেক্টলি বসিয়ে দেওয়া হয়েছে */}
...
import Spinner from "../components/Spinner";
import useAxiosSecure from "../hooks/useAxiosSecure";
// Gravity-UI থেকে প্রয়োজনীয় সব আইকন একসাথে ইম্পোর্ট করা হলো
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row items-stretch gap-6 md:gap-8 border border-emerald-50 dark:border-gray-700">
        ...
        <div className="p-6 md:p-8 md:pl-0 flex-1 flex flex-col justify-between">
          <div>
            ...
            {/* ইনফো গ্রিড (Location, Availability, Mode) - এখানে সুন্দর করে আইকন সেট করা হয়েছে */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
              {tutor.location && (
