...
// const howItWorks = [
//   { icon: "", step: "Browse Tutors", desc: "Explore tutors by subject, schedule, and teaching mode." },
//   { icon: "", step: "Book a Session", desc: "Pick a slot that works for you and confirm your booking instantly." },
//   { icon: "", step: "Start Learning", desc: "Join your session and accelerate your learning journey." },
// ];

// const whyChoose = [
//   { icon: "", title: "Verified Tutors", desc: "All tutors are vetted for qualifications and experience." },
//   { icon: "", title: "Affordable Rates", desc: "Competitive hourly fees with no hidden charges." },
//   { icon: "", title: "Easy to Use", desc: "Simple booking flow with real-time slot availability." },
//   { icon: "", title: "Secure Platform", desc: "Your data is safe with JWT-protected private sessions." },
// ];
...
//       {/* Banner */}
//       <section className={`bg-gradient-to-br ${current.bg} text-white py-24 px-6 text-center transition-all duration-700`}>
//         <h1 className="text-4xl md:text-5xl font-extrabold mb-4 drop-shadow">{current.title}</h1>
//         <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl mx-auto">{current.subtitle}</p>
//         <Link to="/tutors" className="inline-block px-8 py-3 bg-white text-emerald-700 font-bold rounded-full shadow-lg hover:bg-emerald-50 transition">
//           Browse Tutors →
//         </Link>
...
//       {/* How It Works */}
//       <section className="bg-gradient-to-br from-emerald-50 to-cyan-50 dark:from-gray-800 dark:to-gray-900 py-16 px-6">
...
//               <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow hover:shadow-md transition text-center">
//                 <div className="text-4xl mb-3">{item.icon}</div>
//                 <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-1">{item.step}</h3>
...
//             <div key={i} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow hover:shadow-lg transition text-center">
...
// ডেটা অবজেক্টে আইকন কম্পোনেন্টগুলো সেট করা হলো
const howItWorks = [
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {howItWorks.map((item, i) => (
              <div key={i} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow hover:shadow-md transition text-center flex flex-col items-center">
                {/* আইকনটি একদম ওপরে গোল ব্যাজ আকারে রাখা হয়েছে */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {whyChoose.map((item, i) => (
            <div key={i} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 shadow hover:shadow-lg transition text-center flex flex-col items-center">
              {/* আইকনটি ওপরে ব্যাজ আকারে রাখা হয়েছে */}
